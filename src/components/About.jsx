    ...
    <section className="about-section bg-white py-5" id="about">
      <div className="container text-center px-3 px-md-5">
        ...
        <motion.img
          src={pranavImage}
          alt="Pranav Eswar"
          className="about-photo rounded shadow mb-4"
        ...
        {/* About Text */}
        <motion.div
          className="bg-light p-4 p-md-5 rounded shadow text-start mx-auto"
        ...
        >
          ...
          <div className="row text-secondary fs-6 gx-4 gy-3">
            <div className="col-sm-6">
              <strong>Birthday:</strong> 22 Aug
            </div>
            <div className="col-sm-6">
              <strong>Degree:</strong> Bachelors of Computer Applications
            </div>
            <div className="col-sm-6">
              <strong>Website:</strong> <a href="https://pranav1495.github.io" target="_blank" rel="noopener noreferrer">pranav1495.github.io</a>
            </div>
            <div className="col-sm-6">
              <strong>Email:</strong> <a href="mailto:pranavartist1@gmail.com">pranavartist1@gmail.com</a>
            </div>
            <div className="col-sm-6">
              <strong>Phone:</strong> 9074261433
            </div>
            <div className="col-sm-6">
            ...
            <div className="col-sm-6">
              <strong>City:</strong> Trivandrum
            </div>
            <div className="col-sm-6">
              <strong>State:</strong> Kerala
            </div>
            <div className="col-sm-6">
