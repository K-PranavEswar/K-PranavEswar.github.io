...
const socialLinks = [
  { label: 'GitHub', href: 'https://github.com/K-PranavEswar', icon: 'GH' },
  { label: 'LinkedIn', href: `https://www.linkedin.com/in/k-pranav-eswar1/`, icon: 'IN' },
  { label: 'Instagram', href: 'https://www.instagram.com/equizzle_arts/', icon: 'IG' },
